...
- Ivan was the navigator and also worked as the driver. He worked on the taketicket method. 
- Sean was a navigator and also worked as the driver. He worked on the payforticket method.
- Brian was the initial driver who created the git hub repository, shared the link, etc., and worked as a navigator. He worked on the leaveGarage method.

- We worked on the each method individually and we collaborated on the rest of the code.

###### Provide name and approxamite line numbers where each person wrote their code
- Sean ---> Lines:23 through 28
- Ivan ---> Lines:15 through 21
- Brian---> Lines:32 through 37

- Sean/Ivan/Brian ---> Lines 3 through 11, 40 through 60